...
from src.models.marlin.utils import NoArgInit, Singleton, read_yaml
...
class MarlinVitSmallConfig(NoArgInit, SharedConfig, Downloadable):
    ...
    decoder_depth = 4
    decoder_num_heads = 3
    full_model_url = "https://github.com/ControlNet/MARLIN/releases/download/model_v1/marlin_vit_small_ytf.full.pt"
    encoder_model_url = "https://github.com/ControlNet/MARLIN/releases/download/model_v1/marlin_vit_small_ytf.encoder.pt"
...
class MarlinVitLargeConfig(NoArgInit, SharedConfig, Downloadable):
    ...
    decoder_depth = 12
    decoder_num_heads = 8
    full_model_url = "https://github.com/ControlNet/MARLIN/releases/download/model_v1/marlin_vit_large_ytf.full.pt"
    encoder_model_url = "https://github.com/ControlNet/MARLIN/releases/download/model_v1/marlin_vit_large_ytf.encoder.pt"
...
def resolve_config(name: str) -> MarlinConfig:
    if name in _configs:
        ...
        raise ValueError(
            f"Model {name} not found. Please register it first. The current registered models are: "
            f"{_configs.keys()}"
        )
